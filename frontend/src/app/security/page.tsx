    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-black text-[#0067b1] mb-4">Your Security is Our Priority</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
           <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex gap-6">
        ...
        <div className="bg-[#0067b1] rounded-3xl p-12 text-white relative overflow-hidden">
