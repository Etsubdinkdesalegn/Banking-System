          ...
          <div className="md:col-span-12">
             {!token ? (
                <Card className="rounded-3xl border-none shadow-xl overflow-hidden">
                  <div className="bg-[#0067b1] p-8 text-center text-white">
                  ...
                  <CardContent className="p-8 text-center">
                    <div className="grid sm:grid-cols-3 gap-6 mb-8">
                       ...
                       <div className="p-4 bg-gray-50 rounded-2xl">
                          ...
                          <p className="text-xs text-gray-500">Branch Status</p>
                          <p className="text-2xl font-bold text-green-600">Open</p>
                       </div>
                    </div>
                    <Button 
                      onClick={handleBookToken}
                      className="bg-[#0067b1] hover:bg-[#005a9b] px-12 py-7 text-lg rounded-full font-bold transition-all shadow-lg shadow-[#0067b1]/20"
                      disabled={isBooking}
                    >
                ...
                <Card className="rounded-3xl border-2 border-[#00a651] shadow-2xl relative overflow-hidden bg-white">
                  <div className="absolute top-0 right-0 p-4">
                     <div className="bg-[#00a651]/10 text-[#00a651] px-3 py-1 rounded-full text-xs font-bold animate-pulse">
                        LIVE TOKEN
                     </div>
                  </div>
                  <CardContent className="p-12 text-center">
                    ...
                    <div className="bg-gray-50 rounded-3xl p-6 mb-8 grid grid-cols-2 gap-4">
                       <div className="text-left border-r border-gray-200">
                          ...
                          <p className="text-xl font-bold">13th in Line</p>
                       </div>
                       <div className="text-left">
                          <p className="text-xs text-gray-400">Notify me via</p>
                          <p className="text-xl font-bold">SMS Enabled</p>
                       </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                       ...
                       <Button className="bg-[#00a651] hover:bg-[#008d44] rounded-full px-8">
                          Download PDF
                       </Button>
                    </div>
                  </CardContent>
                  <div className="bg-[#00a651] h-2 w-full absolute bottom-0" />
                </Card>
             )}
          </div>
        </div>
        ...
        <div className="mt-16 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
           ...
           <div className="grid md:grid-cols-3 gap-8">
              <div className="space-y-3">
                 <div className="w-10 h-10 bg-[#0067b1] text-white flex items-center justify-center rounded-full font-bold">1</div>
              ...
              <div className="space-y-3">
                 <div className="w-10 h-10 bg-[#0067b1] text-white flex items-center justify-center rounded-full font-bold">2</div>
              ...
              <div className="space-y-3">
                 <div className="w-10 h-10 bg-[#0067b1] text-white flex items-center justify-center rounded-full font-bold">3</div>
                 <h4 className="font-bold">Visit Branch</h4>
